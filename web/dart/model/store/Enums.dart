class Enums {
  static String toName(dynamic dynamic) {
    return dynamic
        .toString()
        .substring(dynamic.toString().lastIndexOf(".") + 1);
  }
}

enum AlgorithmType { NO_ALGORITHM, DIJKSTRA, A_STAR, DJPS, DJPS_LU, DJPS_PC }

class AlgorithmTypes {
  static String getTitle(AlgorithmType algorithmType) {
    switch (algorithmType) {
      case AlgorithmType.NO_ALGORITHM:
        return "None";
      case AlgorithmType.DIJKSTRA:
        return "Dijkstra";
      case AlgorithmType.A_STAR:
        return "A*";
      case AlgorithmType.DJPS:
        return "";
      case AlgorithmType.DJPS_LU:
        return "";
      case AlgorithmType.DJPS_PC:
        return "";
    }
    return "Not Found";
  }
...
enum HeuristicType { ZERO, CHEBYSHEV, EUCLIDEAN, OCTILE, MANHATTAN }
...
enum AlgorithmUpdateMode { DURING_EDITING, AFTER_EDITING, MANUALLY }

class AlgorithmUpdateModes {
  static String getTitle(AlgorithmUpdateMode algorithmUpdateMode) {
    switch (algorithmUpdateMode) {
      case AlgorithmUpdateMode.DURING_EDITING:
        return "During editing";
      case AlgorithmUpdateMode.AFTER_EDITING:
        return "After editing";
      case AlgorithmUpdateMode.MANUALLY:
        return "Manually";
    }
    return "Not Found";
  }
...
enum DirectionMode { ALL, ONLY_CARDINAL, ONLY_DIAGONAL }
  ...
  static String getTitle(DirectionMode directionMode) {
    switch (directionMode) {
      case DirectionMode.ALL:
        return "All";
      case DirectionMode.ONLY_CARDINAL:
        return "Only cardinal";
      case DirectionMode.ONLY_DIAGONAL:
...
enum CornerMode { CROSS, BYPASS }

class CornerModes {
  static String getTitle(CornerMode cornerMode) {
    switch (cornerMode) {
      case CornerMode.CROSS:
        return "Cross";
      case CornerMode.BYPASS:
        return "Bypass";
    }
    return "Not Found";
  }
